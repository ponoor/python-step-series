...
class TestSpeedProfileSettings:
    def test_speed_profile(self, device: step800.STEP800) -> None:
    ...
    def test_fullstep_speed(self, device: step800.STEP800) -> None:
    ...
    def test_set_max_speed(self, device: step800.STEP800) -> None:
        device.set(commands.SetMaxSpeed(2, 1240))

    def test_set_acc(self, device: step800.STEP800) -> None:
        device.set(commands.SetAcc(1, 6002))

    def test_set_dec(self, device: step800.STEP800) -> None:
        device.set(commands.SetDec(4, 155))

    def test_min_speed(self, device: step800.STEP800) -> None:
    ...
    def test_get_speed(self, device: step800.STEP800) -> None:
