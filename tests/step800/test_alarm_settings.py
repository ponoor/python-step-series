...
class TestAlarmSettings:
    ...
    def test_over_current(self, device: step800.STEP800) -> None:
    ...
    def test_stall_report(self, device: step800.STEP800) -> None:
    ...
    def test_prohibit_motion_on_home_sw(self, device: step800.STEP800) -> None:
    ...
    def test_prohibit_motion_on_limit_sw(self, device: step800.STEP800) -> None:
