...
class TestHomingSettings:
    def test_homing_direction(self, device: step400.STEP400, homing_presets) -> None:
        device.set(
    ...
    def test_homing_speed(self, device: step400.STEP400, homing_presets) -> None:
    ...
    def test_go_until_timeout(self, device: step400.STEP400, homing_presets) -> None:
        device.set(
    ...
    def test_release_sw_timeout(self, device: step400.STEP400, homing_presets) -> None:
        device.set(
    ...
    def test_homing(self, device: step400.STEP400, homing_presets) -> None:
